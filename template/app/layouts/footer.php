    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6 single-footer-widget">
                ...
                <ul>
                    <li><a href="<?= url('show-post/' . $mostCommentPosts[0]['id']) ?>"><?= $mostCommentPosts[0]['title']  ?></a></li>
                    <li><a href="<?= url('show-post/' . $mostCommentPosts[1]['id']) ?>"><?= $mostCommentPosts[1]['title']  ?></a></li>
                    <li><a href="<?= url('show-post/' . $mostCommentPosts[2]['id']) ?>"><?= $mostCommentPosts[2]['title']  ?></a></li>
