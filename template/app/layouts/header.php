        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-6 header-top-right no-padding">
                    <ul>
                        <li><span class="lnr lnr-phone-handset"></span><span>@pirplasi On telegram</span></li>
                        <li><a href="mailto:salehisaac200281@gmail.com"><span class="lnr lnr-envelope"></span><span>salehisaac200281@gmail.com</span></a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <ul class="nav-menu">
                    <?php foreach ($categories as $categor) { ?>
                        <li class="menu-active">
                            <a href="<?= url('show-category/' . $categor['id'] )  ?>"><?= $categor['name'] ?></a>
                        </li>
                    <?php } ?>
                </ul>
            </nav>
